...
1. Va sur https://console.firebase.google.com → **Ajouter un projet** (ex: `le-viking`).
...
├── img/background.png   ← Blason de Le Viking (fond du site)
├── js/
...
```bash
cd chemin/vers/le-viking-site
git init
git add .
git commit -m "Init Le Viking"
git branch -M main
git remote add origin https://github.com/TON_COMPTE/le-viking-site.git
